    ...
    <section class="section">
      <div class="section-header">
        <div class="section-header-breadcrumb justify-content-start">
          ...
          <div class="breadcrumb-item">Edit news content</div>
        </div>
      </div>
        @if ($errors->any())
            ...
            <div class="card">
              <form method="POST" action="{{ route('news.update', $new->id) }}" enctype="multipart/form-data">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    <label>Title</label>
                    <input type="text" class="form-control @error('title') is-invalid @enderror" name="title" required value="{{ $new->title, old('title') }}">
                  ...
                  <div class="form-group mb-0">
                    ...
                    <textarea class="form-control @error('description') is-invalid @enderror" name="description" required="">{{ $new->description, old('description') }}</textarea>
                    <div class="invalid-feedback">
